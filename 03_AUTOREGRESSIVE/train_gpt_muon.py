...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x: Tensor, attn_args: AttnArgs):
        ...
        q_3d = q.squeeze(0)  # [T, num_heads, head_dim]
        k_3d = k.squeeze(0)  # [T, num_heads, head_dim]  
        v_3d = v.squeeze(0)  # [T, num_heads, head_dim]
        
        # 使用Flash Attention 2的varlen函数
        ...
        # 将输出重新变为4D [1, T, num_heads, head_dim]
        y = y.unsqueeze(0)
...
class Hyperparameters:
    ...
    train_batch_size: int = 2048 * 2 * 8
    train_max_seq_len: int = 128 * 2
